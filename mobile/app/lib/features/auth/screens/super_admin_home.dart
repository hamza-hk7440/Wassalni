 ...
 @override
  Widget build(BuildContext context) {
    ...
    children: [
      ...
      Row(children: [ _buildStatCard("Daily Revenue", "250 DT", Icons.payments, Colors.green, fullWidth: true),],),
      ...
      const SizedBox(height: 15),
      Row(children: [ _buildStatCard("Active Controllers", "24", Icons.verified_user, Colors.teal, fullWidth: true),],),
      const SizedBox(height: 30),
