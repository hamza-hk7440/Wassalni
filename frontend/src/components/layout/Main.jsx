...
const [darkMode, setDarkMode] = useState(false);
  ...
  return (
    <>
      <div className="min-h-screen pt-24 p-10 flex flex-col items-center gap-12" style={{ backgroundColor: coolPalette.iceWhite }}>

       
        <div className="bg-white p-6 md:p-10 shadow-sm w-full max-w-6xl text-center" 
          style={{ borderRadius: "12px", border: `1px solid ${coolPalette.frostBlue}` }}>
          ...
          <div className="mt-2 flex items-center justify-center gap-4">
            <span className="text-4xl md:text-6xl font-black" style={{ color: coolPalette.deepOcean }}>
          ...
          <p className="text-xs mt-4 font-bold" style={{ color: coolPalette.deepOcean }}>Basé sur {totalPlaces} transactions validées</p>
        </div>
    <div className="bg-white p-6 shadow-sm w-full max-w-6xl rounded-xl border" style={{ borderColor: coolPalette.frostBlue }}>
  ...
  <p className="mt-6 text-[10px] font-bold text-gray-400 text-center uppercase">
    Le remplissage des barres est relatif à l'objectif quotidien (60 DT)
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl px-4">
          ...
          <div onClick={() => navigate('/agents')}
            className="bg-white p-6 rounded-xl shadow-sm border-l-4 w-full text-center cursor-pointer transition-all hover:bg-gray-50 hover:shadow-md active:scale-95"
            style={{ borderLeftColor: coolPalette.paleYellow }}>
            <span className="text-4xl mb-2 block">👨‍💼</span> 
