...
function RoutesPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name.trim()) {
      setFormError(t("routeNameRequired", "Route name is required."));
      return;
    }
    ...
    if (
      ...
      setFormError(
        t("basePricePositive", "Base price must be a positive number or zero."),
      );
      return;
    }
    ...
    try {
      ...
      if (editingId) {
        ...
        setFormSuccess(t("routeUpdatedSuccess", "Route updated successfully."));
      } else {
        await createRoute(payload);
        setFormSuccess(t("routeAddedSuccess", "Route added successfully."));
      }
      resetForm();
      fetchRoutes();
    } catch (err) {
          ...
          <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-sm mt-1" style={{ color: palette.textGray }}>
                {t(
                  "routesSubtitle",
                  "Configure routes between stations with a clear interface.",
                )}
              </p>
            </div>
            <div
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            <div className="flex flex-col gap-2">
              ...
              <input
                type="text"
                placeholder={t("routeNamePlaceholder", "Ex: Line 1")}
                value={name}
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                min="0"
                step="0.01"
                placeholder={t("basePricePlaceholder", "Ex: 2.50")}
                value={basePrice}
            ...
            <tbody>
              {routesData.map((route) => {
                const startSt =
                  stations.find(
                    (s) =>
                      String(s.station_id) === String(route.start_station_id),
                  )?.name ||
                ...
                const endSt =
                  stations.find(
                    (s) =>
                      String(s.station_id) === String(route.end_station_id),
                  )?.name ||
                ...
                return (
                  ...
                  >
                    ...
                    <td className="p-4" style={{ color: palette.textGray }}>
                      {Number(route.base_price ?? 0).toFixed(2)}
                    </td>
